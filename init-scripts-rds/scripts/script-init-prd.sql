...
BEGIN
    ...
    EXECUTE format('GRANT USAGE ON SCHEMA %I TO rl_ad', schema_name);
    EXECUTE format('GRANT SELECT ON ALL TABLES IN SCHEMA %I TO rl_ad', schema_name);
    EXECUTE format('GRANT SELECT ON ALL SEQUENCES IN SCHEMA %I TO rl_ad', schema_name);
